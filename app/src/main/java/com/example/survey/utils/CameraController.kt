...
class CameraController(
    ...
    fun capturePhoto(
        ...
        val capturedRotation = deviceRotationDegrees
        val isLandscape = (capturedRotation == 90 || capturedRotation == 270)

        Log.d(TAG, "Capturing photo - Sensor rotation: ${capturedRotation}°, isLandscape: $isLandscape")


        val surfaceRotation = when (capturedRotation) {
    ...
    private fun addOverlayToImage(
        ...
        return try {
            ...
            val orientedBitmap = rotateBitmap(rawBitmap, orientation)





            val finalBitmap = orientedBitmap
